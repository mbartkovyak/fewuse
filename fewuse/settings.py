"""
Django settings for fewuse project.
...
SECRET_KEY = 'django-insecure--g77ow&6d)*l8m(3*6%8ur#d6()wv3_)r^gv^f3%1zaiaiz5_k'
...
WSGI_APPLICATION = 'fewuse.wsgi.application'
